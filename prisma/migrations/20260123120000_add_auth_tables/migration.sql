-- AlterTable: добавляем поля Auth.js в users
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "email_verified" TIMESTAMP(3),
ADD COLUMN IF NOT EXISTS "image" TEXT;

-- CreateTable: accounts (Auth.js / NextAuth)
...
-- CreateTable: sessions (Auth.js / NextAuth)
...
-- CreateTable: verification_tokens (Auth.js / NextAuth)
