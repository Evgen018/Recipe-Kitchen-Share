Ты — ведущий fullstack-разработчик. Работаем в существующем проекте Recipe-Kitchen-Share (Next.js App Router + TypeScript + Prisma + Neon/Postgres + Auth). Нужно добавить лайки к ПУБЛИЧНЫМ промтам.
